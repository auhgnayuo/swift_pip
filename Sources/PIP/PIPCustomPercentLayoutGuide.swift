//
//  PIPCustomPercentLayoutGuide.swift
//  PIP
//
...
/// PIPCustomPercentLayoutGuide is a UILayoutGuide that supports percentage-based sizing relative to a parent layout guide.
/// It is used for positioning and sizing PiP content as a percentage of its container.
class PIPCustomPercentLayoutGuide: UILayoutGuide {
