//
//  CustomControllerContainerView.swift
//  PIP
//
...
public extension PIP.CustomController {
    /// ContainerView is the main container for Picture-in-Picture (PiP) content.
    ...
    class ContainerView: UIView {
        ...
        lazy var widthLayoutGuide: PercentLayoutGuide = {
            let v = PercentLayoutGuide(dimension: .width)
            v.identifier = "Width"
            addLayoutGuide(v)
        ...
        lazy var heightLayoutGuide: PercentLayoutGuide = {
            let v = PercentLayoutGuide(dimension: .height)
            v.identifier = "Height"
            addLayoutGuide(v)
            v.parent = snapLayoutGuide
            return v
