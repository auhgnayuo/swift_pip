//
//  CustomControllerContentView.swift
//  PIP
//
...
public extension PIP.CustomController {
    /// ContentView is the main view for displaying Picture-in-Picture (PiP) content.
    ...
    class ContentView: UIView {
        ...
        public var containerView: ContainerView? {
            return superview as? ContainerView
        }
        ...
        func adaptiveLayout(contentFrame: CGRect? = nil, snap: Bool? = nil, collapse: Bool? = nil) -> Layout? {
